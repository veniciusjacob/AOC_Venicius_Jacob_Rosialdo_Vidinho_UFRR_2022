...
-- *****************************************************************************
-- Generated on "03/09/2022 16:59:18"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          DivInstru
-- 
...
ENTITY DivInstru_vhd_vec_tst IS
END DivInstru_vhd_vec_tst;
ARCHITECTURE DivInstru_arch OF DivInstru_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL entrada : STD_LOGIC_VECTOR(7 DOWNTO 0);
SIGNAL saida_jump : STD_LOGIC_VECTOR(3 DOWNTO 0);
SIGNAL saida_OpCode : STD_LOGIC_VECTOR(3 DOWNTO 0);
SIGNAL saida_rs : STD_LOGIC_VECTOR(1 DOWNTO 0);
SIGNAL saida_rt : STD_LOGIC_VECTOR(1 DOWNTO 0);
COMPONENT DivInstru
	PORT (
